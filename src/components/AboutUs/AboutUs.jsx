  ...
  return (
    <div className="p-4 md:p-10 space-y-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        <div className="bg-white p-6 rounded-xl shadow-lg flex flex-col items-center text-center hover:scale-105 transition-transform duration-300">
      ...
      {/* Mission Statement */}
      <div className="bg-gradient-to-r from-indigo-50 to-purple-50 p-6 md:p-10 rounded-xl shadow-lg space-y-4">
